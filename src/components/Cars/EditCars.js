...
export default function EditCars(props) {
    ...
    //     props.updateTask(urlRef.current.value,marqRef.current.value, prixRef.current.value, modelRef.current.value, selectedId)
    // }
                    ...
                    <form >
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" aria-label="Close" onClick={handleClickUpdate} className="btn btn-success " ><i className="fas fa-edit" />Update</button>
                            </div>
                        </div>
                    </form>
                </div>
